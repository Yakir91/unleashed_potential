...
export default function Gallery() {
  ...
  const galleryItems = [
    { id: 1, category: ['training', 'outdoor'], image: '/images/gallery/igp-heelwork-1.png' },
    { id: 2, category: ['training', 'outdoor'], image: '/images/gallery/igp-heelwork-2.png' },
    { id: 3, category: ['training', 'outdoor'], image: '/images/gallery/igp-protection-1.png' },
    { id: 4, category: ['training', 'outdoor'], image: '/images/gallery/igp-tracking-1.png' },
    { id: 5, category: ['training', 'outdoor'], image: '/images/gallery/igp-obedience-1.png' },
    { id: 6, category: ['training', 'outdoor'], image: '/images/gallery/igp-retrieve-1.png' },
    { id: 7, category: ['training', 'outdoor'], image: '/images/gallery/igp-agility-1.png' },
    { id: 8, category: ['training', 'outdoor'], image: '/images/gallery/igp-protection-2.png' },
    { id: 9, category: ['training', 'outdoor'], image: '/images/gallery/igp-protection-3.png' },
    { id: 10, category: ['before-after', 'outdoor'], image: '/images/gallery/igp-award-1.png' },
    { id: 11, category: ['training', 'outdoor'], image: '/images/gallery/igp-heelwork-3.png' },
    { id: 12, category: ['training', 'outdoor'], image: '/images/gallery/igp-heelwork-4.png' },
    { id: 13, category: ['training', 'outdoor'], image: '/images/gallery/igp-protection-4.png' },
    { id: 14, category: ['training', 'outdoor'], image: '/images/gallery/igp-protection-5.png' },
    { id: 15, category: ['training', 'outdoor'], image: '/images/gallery/igp-protection-6.png' },
    { id: 16, category: ['puppies', 'outdoor'], image: '/images/gallery/puppy_img.jpg' },
    { id: 17, category: ['training', 'outdoor'], image: '/images/gallery/group_class.jpg' },
  ].map((item) => ({
    ...item,
    title: t(`gallery.items.${item.id}.title`),
    description: t(`gallery.items.${item.id}.description`),
  }))
